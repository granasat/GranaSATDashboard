...
(function() {
  ...
  formatNumber = function(num) {
    return addCommas(Number(num).toFixed(0));
  };
  ...
  Gauge = (function(_super) {
    ...
    Gauge.prototype.render = function() {
      ...
      } else if (this.options.gradients.length > 1) {
        if (this.options.gradientType === 0) {
          fillStyle = this.ctx.createRadialGradient(w, h, 9, w, h, 70);
        } else {
          fillStyle = this.ctx.createLinearGradient(0, 0, w*2, 0);
        }
        var step = (this.options.gradients.length < 2 ? 1.0 : 1.0 / (this.options.gradients.length-1));
        for(i = 0; i < this.options.gradients.length; i++) {
            fillStyle.addColorStop(i * step, this.options.gradients[i]);
        }
      } else {
        fillStyle = this.options.gradients[0];
      }
  ...
  BaseDonut = (function(_super) {
    ...
    BaseDonut.prototype.render = function() {
      ...
      grdFill.addColorStop(0, this.options.gradients[0]);
      grdFill.addColorStop(1, this.options.gradients[this.options.gradients.length-1]);
